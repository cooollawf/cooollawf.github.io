---
title: Thinkpad X200刷coreboot从入门到入土
...
> [!CAUTION]
> 不要！不要！一定不要去贪买CH341A的钱！必须到了再读取，在经过本人测试后，Thinpad X200的大部分固件区域都拥有保护，如果不使用CH341a烧录器则无法完全读取出BIOS区域，并且可能会导致之后的BIOS无法使用并毁坏机器
